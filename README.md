...
DevAlert is an observability solution for crashes, errors and anomalies in IoT/Edge device software. By adding a small set of "alerts" at strategic locations in your code, like demonstrated in this project, software issues and anomalies can be captured, e.g., hardware fault exceptions, failed ASSERT checks and stack corruptions from buffer overruns. The alerts provide detailed diagnostic information such as core dumps and system traces. You can create your own alert types and include any diagnostic data of interest.
