...
/**
 * @brief: Produces an Alert using CrashCatcher, including a core dump and a trace.
 * Usage example: DFM_TRAP( DFM_TYPE_BAD_MESSAGE, "Bad message received")
 ...
 *
 * DFM_TRAP is implemented by signaling the Non-Maskable Interrupt (NMI), which is handled by CrashCatcher.
 */
