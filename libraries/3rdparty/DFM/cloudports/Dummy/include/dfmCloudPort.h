 ...
 ******************************************************************************/
#define DFM_CLOUD_PORT_SEND(pvData, ulSize, szUniqueSessionID, ulTraceCounter, szType, ulSlice, ulSlices, pulBytesSent) ulDfmDummyCloudPortSend(pvData, ulSize, szUniqueSessionID, ulTraceCounter, szType, ulSlice, ulSlices, pulBytesSent)
